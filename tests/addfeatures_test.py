...
def test_exit_no_option():
    # It's valid to run 'addfeatures' without using any options,
...
def test_build_font_and_check_messages(args, ttx_fname):
    ...
    stderr_path = runner(CMD + [
        '-s', '-e', '-o', 'f', f'_{get_input_path("font.cff")}',
...
def test_GDEF_LigatureCaret_bug155(caret_format):
    input_filename = 'bug155/font.cff'
...
def test_useMarkFilteringSet_flag_bug196():
    input_filename = "bug196/font.cff"
...
def test_useException_bug321():
    input_filename = "bug321/font.cff"
...
def test_mark_refer_diff_classes_bug416():
    input_filename = "bug416/font.cff"
...
def test_DFLT_script_with_any_lang_bug438():
    ...
    tag. With the fix, addfeatures will build an OTF which is identical to
    'bug438.ttx'. Without the fix, it will fail to build an OTF."""
    input_filename = 'bug438/font.cff'
...
def test_glyph_not_in_font_bug492():
    input_filename = 'bug492/font.cff'
...
def test_feature_recursion_bug628():
    input_filename = 'bug628/font.cff'
...
def test_recalculate_bbox_bug617():
    input_filename = "bug617/font.cff"
    goadb_filename = "bug617/goadb.txt"
    ttx_filename = "bug617/no_gs_opt.ttx"
    actual_path = get_temp_file_path()
    runner(CMD + ['-o', 'f', f'_{get_input_path(input_filename)}',
...
def test_contextual_multiple_substitutions_bug725():
    input_filename = "bug725/font.cff"
...
def test_notdef_in_glyph_class_bug726():
    input_filename = "bug726/font.cff"
...
def test_overflow_bug731():
    input_filename = 'bug731/font.cff'
...
def test_base_anchor_bug811():
    input_filename = 'bug811/font.cff'
...
def test_max_revision_bug876():
    input_filename = 'bug876/font.cff'
...
def test_infinite_loop_with_dflt_lookups_bug965():
    input_filename = 'bug965/font.cff'
...
def test_bug993():
    input_filename = 'fealib/font.cff'
...
def test_bug1040(cmap_filename, cs, expectedOS2):
    ...
    cmd = CMD + ['-o', 'f', f'_{get_input_path("bug1040/cidfont.cff")}',
                       'cs', f'_{cs}',
                       'o', f'_{out_path}',
...
def test_parameter_offset_overflow_bug1017():
    ...
    input_filename = 'bug1017/font.cff'
...
def test_spec(path):
    ...
    if ".cid" in name:
        input_filename = "spec/fontcid.cff"
    else:
        input_filename = "spec/font.cff"
...
def test_heap_after_free_bug1349():
    ...
    """
    folder = "bug1349/"
    input_filename = get_input_path(folder + "cidfont.subset.cff")
